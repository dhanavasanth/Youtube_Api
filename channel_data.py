        ...
        for item in playlist_videos:
            ...
            if video_response['items']:
                video_info = {
                    ...
                    "Video_Description": video_response['items'][0]['snippet']['description'] if 'description' in video_response['items'][0]['snippet'] else "Not Available",
                    "Tags": video_response['items'][0]['snippet']['tags'] if 'tags' in video_response['items'][0]['snippet'] else "Not Available",
                    "PublishedAt": video_response['items'][0]['snippet']['publishedAt'] if 'publishedAt' in video_response['items'][0]['snippet'] else "Not Available",
                    ...
                    "Thumbnail": video_response['items'][0]['snippet']['thumbnails']['high']['url'] if 'thumbnails' in video_response['items'][0]['snippet'] else "Not Available",
                    "Comments": {}
                    }
