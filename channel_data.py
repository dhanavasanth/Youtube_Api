...
def get_playlist_data(youtube,playlist_id,channel_id):
  playlist_info = []
...
def get_video_data(youtube, channel_id, playlist_id):
    ...
    for video in videos_response['items']:
        ...
        video_info = {
            ...
            "Caption_Status": video_response['items'][0]['contentDetails']['caption'] if 'caption' in video_response['items'][0]['contentDetails'] else "Not Available",
            "Comments": {},
        }
    ...
    playlist_data = get_playlist_data(youtube,playlist_id,channel_id)
